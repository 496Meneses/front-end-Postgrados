      ...
      <Card style={{ width: '40rem'  }}>
        ...
        <br></br>
            ...
            >
              ...
              <TextField
                fullWidth
                label="Titulo del articulo, capitulo, libro, monografia..."
                name="descripcion"
                onChange={handleChange}
                required
              ...
              <TextField
                fullWidth
                label="Nombre de la publicación o titulo del libro"
                name="descripcion"
                onChange={handleChange}
                required
                value={values.Descripcion}
              ...
              <TextField
                fullWidth
                label="Datos generales del tipo de publicación"
                name="descripcion"
                onChange={handleChange}
                required
                value={values.Descripcion}
              ...
              <TextField
                id="FechaInicio"
                label="Fecha de envío editorial"
                type="FechaInicio"
